...
public class BookMapper extends CommonMapper {
    ...
    public static BookDTO toDto(Book book) {
        return new BookDTO(
                ...
                book.getTitle(),
                book.getYear(),
                modifyStringForTests(                    // TODO: Accessing book.getAuthor().getName() outside an active transaction
                        book.getAuthor().getName()       // may cause LazyInitializationException due to lazy loading.
